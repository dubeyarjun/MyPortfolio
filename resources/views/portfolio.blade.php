...
<head>
  ...
  <style>
    body { background: #f8f9fa; font-family: 'Poppins', sans-serif; scroll-behavior: smooth; }
  ...
  /* object-fit: cover; */
    ...
    .hero-content img:hover { transform: scale(1.05); }
    .hero-text h1 { font-size: 3.5rem; font-weight: 700; }
    .hero-text h3 { font-size: 1.5rem; color: #e2e2e2; }
.hero-text p {
  max-width: 600px;
  margin: 0 auto;
  font-size: 1.1rem;
...
@media (max-width: 768px) {
  .hero-content img { width: 200px; height: 200px; }
  .glow-btn { padding: 8px 25px; }
  .tech-icons img { width: 40px; height: 40px; }
}
...
/* Color accents */
.node.html { border-color: #e34f26; box-shadow: 0 0 20px rgba(227,79,38,0.4); }
.node.css { border-color: #1572B6; box-shadow: 0 0 20px rgba(21,114,182,0.4); }
.node.js { border-color: #f7df1e;  box-shadow: 0 0 20px rgba(247,223,30,0.4); }
.node.php { border-color: #787CB5; box-shadow: 0 0 20px rgba(120,124,181,0.4); }
.node.laravel { border-color: #FF2D20; box-shadow: 0 0 20px rgba(255,45,32,0.4); }
.node.bootstrap { border-color: #7952b3; box-shadow: 0 0 20px rgba(121,82,179,0.4); }
.node.reactnative { border-color: #61DBFB; box-shadow: 0 0 20px rgba(97,219,251,0.4); }
.node.mysql { border-color: #00758f; box-shadow: 0 0 20px rgba(0,117,143,0.4); }
...
/* Root Glow */
@keyframes glow {
  0% { box-shadow: 0 0 15px rgba(155, 89, 182, 0.5); }
  100% { box-shadow: 0 0 35px rgba(155, 89, 182, 1); }
}

/* Responsive */
@media (max-width: 768px) {
  .branch ul { gap: 25px; }
  .node { padding: 10px 20px; font-size: 0.9rem; }
}
...
@keyframes pulse {
  ...
  50% { box-shadow: 0 0 35px rgba(155, 89, 182, 0.8); }
}
...
.edu-item {
  position: relative;
  padding-left: 25px;
  border-left: 3px solid #cddc39; /* light lime line */
}
  ...
  <div class="container">
    ...
    <div class="tree">
      ...
      <div class="branch">
        <div class="line"></div>
        <ul>
          <li><div class="node html">HTML</div></li>
          <li><div class="node css">CSS</div></li>
          <li><div class="node bootstrap">Bootstrap</div></li>
          <li><div class="node js">JavaScript</div></li>
          <li><div class="node reactnative">React Native</div></li>
          <li><div class="node php">PHP</div></li>
          <li><div class="node laravel">Laravel</div></li>
          <li><div class="node mysql">MySQL</div></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3 mb-4">
        ...
        <p><i class="fas fa-map-marker-alt me-2 text-danger"></i> Delhi, India</p>
        <p><i class="fas fa-envelope me-2 text-info"></i> dubeyneeraj412@gmail.com</p>
        <p><i class="fas fa-phone me-2 text-danger"></i> +91 9125438519</p>
      </div>
    </div>
...
$(document).ready(function(){
  $('.glitch-text').css('opacity', 0).animate({opacity: 1}, 1200);
});
</script>
